...
function s() {
  return s = Object.assign ? Object.assign.bind() : function(t2) {
    for (var s2 = 1; s2 < arguments.length; s2++) {
      var e2 = arguments[s2];
      for (var i2 in e2)
        ({}).hasOwnProperty.call(e2, i2) && (t2[i2] = e2[i2]);
    }
    return t2;
...
var c = class {
  constructor({ lenisOptions: t2 = {}, modularInstance: s2, triggerRootMargin: e2, rafRootMargin: i2, autoResize: r2 = true, autoStart: l2 = true, scrollCallback: n2 = () => {
    ...
    for (const [s3] of Object.entries(t2))
      ["wrapper", "content", "infinite"].includes(s3) && console.warn(`Warning: Key "${s3}" is not possible to edit in Locomotive Scroll.`);
